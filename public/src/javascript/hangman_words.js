const wordList = [
    ...
    { word: "fireworks", hint: "Explosive devices used for celebrations, creating colorful displays in the sky." },
    { word: "penguin", hint: "A flightless bird found in the Southern Hemisphere, known for its black and white coat." },
    { word: "harmony", hint: "A pleasing combination of musical notes or a state of peaceful existence." },
    { word: "alchemy", hint: "A medieval science focused on transforming matter, often seeking to turn metals into gold." },
    { word: "compass", hint: "A navigational instrument used to determine direction." },
    { word: "crescendo", hint: "A gradual increase in loudness in a piece of music." },
    { word: "starlight", hint: "The light emitted by stars visible in the night sky." },
